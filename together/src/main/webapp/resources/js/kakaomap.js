 ...
 var placeName;
			...
			function showConfirmedPlace() {
				document.querySelector(".locationInfo--name").innerText = placeName;
				document.querySelector(".locationInfo--address").innerText = "[ " + placeAddress + " ]";
				
				// form 값 전달을 위한 hidden input 태그 값 설정
				document.querySelector(".locationInfo--name--input").value = placeName;
				document.querySelector(".locationInfo--address--input").value = placeAddress;
